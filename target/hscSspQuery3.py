...
def query(
        ...
        outputfile="query.fits",
        pw=None,
        sql=None):
    global args
    args["user"] = user
    args["release_version"]=release_version
    args["delete_job"]=delete_job
    args["out_format"] = form
    args["nomail"]=nomail
    args["preview"]=preview
    args["skip_syncheck"]=skip_syncheck
...
def submitJob(credential, sql, out_format):
    ...
    postData = {'credential': credential, 'catalog_job': catalog_job, 'nomail': args["nomail"], 'skip_syntax_check': args["skip_syncheck"]}
