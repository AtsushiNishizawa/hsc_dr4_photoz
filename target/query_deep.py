...
#
# you will be asked
# 1) tract list in a text format (e.g. tract_list_deep.txt)
# 2) hscSspQuery3.py
# 3) master query file (target_deep_s23b_master.sql)
#
...
if ( __name__ == "__main__" ):
    ...
    #
    TractListFile = "tract_list_deep.txt"
    ...
    #
    MasterQueryFile = "target_deep_s23b_master.sql"
    ...
    for tract1, tract2 in zip(tracts1, tracts2):
        ...
        OutFileName = "deep/target_deep_s23b_%05i-%05i.fits"%(int(tract1), int(tract2))
        print (OutFileName)
